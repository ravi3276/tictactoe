const tictactoe = (function(){
    ...
    //cellelement length 9
    for (let index = 0; index < cellElements.length; index++) {
        //9 cell each cell contain click event
    ...
    function checkWinner() {
        ...
        if(winner !== null) { //when ever wins
            ...
            playing = false;
            infoElement.innerHTML = 'DRAW<br><butoogleTurntton onclick="tictactoe.restart()">RESTART</button>';
        }
    }
